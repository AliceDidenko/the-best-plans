...
const Main = ({idSelected, doingCategoryList, StateDoing, onChangeValueInput, onclickDelete,
    ...
    return (<div id='main'>
        {idSelected === '0' && <GridCategory StateDoing={StateDoing} doingCategoryList={doingCategoryList} onChangeValueInput={onChangeValueInput} onclickDelete={onclickDelete}
        ...
        {idSelected === '1' && <GridState    StateDoing={StateDoing} doingCategoryList={doingCategoryList} onChangeValueInput={onChangeValueInput} onclickDelete={onclickDelete}
        ...
        {idSelected === '2' && <GridRank     StateDoing={StateDoing} doingCategoryList={doingCategoryList} idSelected='2' onChangeValueInput={onChangeValueInput}  onclickDelete={onclickDelete}
                                                dragStartHandler={dragStartHandler_doings}
                                                dragEndHandler={dragEndHandler_doings}
                                                dragLeaveHandler={dragLeaveHandler_doings} 
                                                dragOverHandler={dragOverHandler_doings}
                                                dragDropHandler={dragDropHandler_doings}/>}
        {idSelected === '3' && <GridRank     StateDoing={StateDoing} doingCategoryList={doingCategoryList} idSelected='3' onChangeValueInput={onChangeValueInput} onclickDelete={onclickDelete}
                                                dragStartHandler={dragStartHandler_doings}
                                                dragEndHandler={dragEndHandler_doings}
                                                dragLeaveHandler={dragLeaveHandler_doings} 
                                                dragOverHandler={dragOverHandler_doings}
